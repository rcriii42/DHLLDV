...
if __name__ == '__main__':
    ...
    for v, Cvthis  in zip(LDV_by_Cv, Cv_list):
        return_list = DHLLDV_framework.Erhg_graded(GSD, v, Dp, epsilon, nu, rhol, rhos, Cvthis, Cvt_eq_Cvs=True, get_dict=True)
    ...
    LDV_by_d = [DHLLDV_framework.LDV(None, Dp, dthis, epsilon, nu, rhol, rhos, Cv)
                      for dthis in d_list]
    il_Erhg_im = []
    ...
    if plt:
        ...
        # log x and y axis
        Erhg_title = "Erhg for Dp=%0.3fm, d50=%0.2fmm, D85=%0.2fmm, Rsd=%0.3f, Cv=%0.3f, rhom=%0.3f"%(Dp, d*1000, GSD[0.85]*1000, Rsd, Cv, rhom)
        ...
        HG_title = "Hydraulic gradient for Dp=%0.3fm, d50=%0.2fmm, D85=%0.2fmm, Rsd=%0.3f, Cv=%0.3f, rhom=%0.3f"%(Dp, d*1000, GSD[0.85]*1000, Rsd, Cv, rhom)
        ...
        HG_plot.plot(LDV_by_Cv, LDV_by_Cv_im, color='magenta', marker='^', linestyle='dotted', linewidth=1, label="LDV by Cv")
