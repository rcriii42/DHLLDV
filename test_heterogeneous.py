...
class Test(unittest.TestCase):
    ...
    def test_Ehrg1(self):
        ...
        rhol = DHLLDV_constants.water_density[20]
        Cvs = 0.1
        self.assertAlmostEqual(heterogeneous.Erhg(vls, Dp, 0.0075/1000, epsilon, nu, rhol, rhos, Cvs), 0.0000051)
        self.assertAlmostEqual(heterogeneous.Erhg(vls, Dp, 0.2/1000, epsilon, nu, rhol, rhos, Cvs), 0.0119203)
        self.assertAlmostEqual(heterogeneous.Erhg(vls, Dp, 0.4/1000, epsilon, nu, rhol, rhos, Cvs), 0.0528735)
