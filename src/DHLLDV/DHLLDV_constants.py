...
water_viscosity = interpDict(dict((t, water_dynamic_viscosity[t]/(1000*water_density[t]))
                                  for t in water_density.keys()))

# Lookup table for calculating the angle beta for a given proportion of a pipe filled
# Arel = Adesired/Atotal
# beta in radians
Arel_to_beta = interpDict({0.00000: 0.0000000,
                           0.0000721: 0.0698132,
                           0.000575: 0.1396263,
                           0.00112: 0.1745329,
                           0.00193: 0.2094395,
